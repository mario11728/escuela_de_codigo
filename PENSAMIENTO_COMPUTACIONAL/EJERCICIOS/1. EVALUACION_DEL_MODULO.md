...
por cada respuesta correcta de la tabla )
    ...
    fuente) escritas en cierto lenguaje de                                compilador
    ...
    sus componentes al lenguaje máquina, es                                ejecucion de programa
...
1. Menciona al menos 3 tipos de datos que existen: (valor 0.4)
    ...
    Respuesta: numericos, logicos y caracter 
...
2. ¿Qué tipo es cada uno de los siguientes datos? (valor 0.4 por cada inciso)
        ...
        f) La edad de una persona                                                      logico

        g) El pago por un servicio o producto                                          logico
...
Nombre Completo: MArio Eduardo Castro Engambira

Peso en kilogramos:80Kl

Correo electrónico: ultronkurama@gmail.com

Número de teléfono: 5554354926

Resuelve el siguiente CAPTCHA: 3 > 4 ¿Cierto o Falso? no
...
Indica que tipo de variable es en cada caso: (valor 0.3 por cada uno)
                                           ...
                                           Tipo de variable
    11. iva = 0.15                           cuantitativo

    12. letra = ‘a’                          cualitativo

    13. suma = a + b/ c                      cuantitativo

    14. interrup = true                      cualitativo

    15. apellido= ‘lopez’                    cualitativo

    16. x = x + 1                            cuantitativo

    17. suma = suma + num                    cualitativo

    18. c = sqrt(a*a + b*b)                  cuantitavivo

    19. costo=750                            cuantitativo

    20. i = i - 1                            cuantitativo
